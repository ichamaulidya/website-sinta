...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="<?php echo e(route('publications.index')); ?>" class="<?php echo e(Request::routeIs('publications.index') ? 'active' : ''); ?>">
                    <span class="icon">📚</span>
...
</html><?php /**PATH C:\Users\asa yuaziva\OneDrive\Documents\sinta project\sinta-app\resources\views/app.blade.php ENDPATH**/ ?>